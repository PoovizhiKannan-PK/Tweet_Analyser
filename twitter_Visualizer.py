...
if __name__ == "__main__":
	...
	time_likes = pd.Series(data=df['retweetcount'].values, index=df['date'])
	time_likes.plot(figsize=(16,4), color='r', label='ReTweets', legend=True)
	plt.show()